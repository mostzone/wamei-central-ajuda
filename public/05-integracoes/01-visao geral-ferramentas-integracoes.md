...
Esta seção agrupa um conjunto de ferramentas e funcionalidades que expandem as capacidades do Wamei Chat para além do atendimento convencional por texto. Aqui você encontrará canais de comunicação alternativos como a telefonia e recursos que permitem conectar o Wamei Chat a outros sistemas.
...
A configuração é feita através da conexão de credenciais Wavoip nas configurações do canal Baileys dentro do Wamei Chat. Para detalhes completos, consulte a documentação de [Ligações e Telefonia](./ligacoes-telefonia).
...
Para detalhes completos, consulte a documentação de [Notificações Web Push](./notificacoes-web-push).

## Conteúdo Relacionado

Para aprofundamento nas funcionalidades descritas, consulte:

- [Ligações e Telefonia](./ligacoes-telefonia)
- [Notificações Web Push](./notificacoes-web-push)
